...
checks = [
    ...
    check("gps python", "ls /usr/local/lib/python3.5/dist-packages | grep -i pynmea2", {"pip": ["pynmea2"], }),
    ...
    check("fuel gauge", "i2cdetect -y 1 | grep 36", {"hardware": ["Fuel gauge not found"]}),
